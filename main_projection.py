...
def Draw3D():
    ...
    # Objects to world
    matrix = tdmath.translationMatrix(200,200,100,matrix) # Put in world


    # Camera view perspective
   
    matrix = tdmath.projectionMatrix(400,200,200,0,rotateCamX,rotateCamY,rotateCamZ,matrix) # Camera angle xyz xyzrotation world

    # Adapt to screen
    matrix = tdmath.translationMatrix(200,200,0,matrix) # Put in Camera?
